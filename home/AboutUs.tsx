...
export default function AboutUs() {
  return (
    <section className="bg-[#ffffff] mt-20 py-20 px-6 md:px-16 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center px-20">
        ...
        >
          {/* Small Title */}
          <h2 className="text-lg font-medium text-[#5552D9] mb-5">About Us</h2>
          ...
          <div className="hidden md:block mt-10">
            <button className="bg-[#5552D9] hover:bg-[#4338CA] text-white px-8 py-4 rounded-full font-medium transition-all duration-300 hover:scale-105 shadow-md">
              See More
            </button>
          </div>
        </motion.div>
